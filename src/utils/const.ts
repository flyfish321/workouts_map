...
const CHINESE_LOCATION_INFO_MESSAGE_FIRST =
  'You got to put the past behind you before you can move on. And I think that is what my running was all about.';
const CHINESE_LOCATION_INFO_MESSAGE_SECOND = 'Yesterday you said tomorrow.';
